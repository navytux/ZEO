...
from ZODB.utils import maxtid, p64, u64, z64, tid_repr
...
class FullGenericTests(
    ...
    def check_ZZ_race_loadopen_vs_local_invalidate(self):
        db = ZODB.DB(self._storage)
        ...
        def verify():
            ...
            v2 = obj2.value
            if v1 != v2:
                msg  = "verify: obj1.value (%d)  !=  obj2.value (%d)\n" % (
                       v1, v2)
    ...
    @with_high_concurrency
    def check_ZZ_race_load_vs_external_invalidate(self):
